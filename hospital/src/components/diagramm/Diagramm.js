        ...
        <div className="display__article">
            <div className="circle">
                <svg  viewBox="0 0 40 40" className="donut">
                    ...
                    <circle cx="17" cy="21" r="15.91549430918954" fill="transparent" stroke="darkblue" strokeWidth="2" strokeDasharray="15 85" strokeDashoffset="25"></circle>
                    <g>
            ...
            <div className="display__text">
                <div className="title">Who needs the visit?</div>
